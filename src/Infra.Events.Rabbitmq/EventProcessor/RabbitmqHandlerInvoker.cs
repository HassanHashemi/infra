...
public class RabbitmqHandlerInvoker
{
    private readonly ILifetimeScope _scope;
    private readonly Assembly[] _scanningAssemblies;
    private readonly IJsonSerializer _jsonSerializer;
    private readonly IOptions<RabbitmqConsumerConfig> _options;
    private readonly ILogger<RabbitmqHandlerInvoker> _logger;

    public RabbitmqHandlerInvoker(
        ILifetimeScope scope,
        ILogger<RabbitmqHandlerInvoker> logger,
        ...
        IOptions<RabbitmqConsumerConfig> options)
    {
        ...
        this._jsonSerializer = rabbitmqOptions.Value.Serializer ?? new DefaultNewtonSoftJsonSerializer();
